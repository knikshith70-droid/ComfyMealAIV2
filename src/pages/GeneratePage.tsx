  ...
  const generate = async (override?: FlexState) => {
    ...
    try {
      if (!profile || !profile.id) {
        throw new Error("Your profile is not loaded yet. Please complete onboarding first.");
      }
      if (!active.stock_level || !active.cook_capacity || !active.meal_type) {
        throw new Error("Please select your stock level, cooking capacity, and meal type.");
      }
